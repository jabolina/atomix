...
/**
 * Generic multicast partition group configuration
 */
public class GenericMulticastPartitionGroupConfig extends PartitionGroupConfig<GenericMulticastPartitionGroupConfig> {
  ...
  public PartitionGroup.Type getType() {
    return GenericMulticastPartitionGroup.TYPE;
  }
   ...
   */
  public GenericMulticastPartitionGroupConfig setMemberGroupStrategy(MemberGroupStrategy memberGroupStrategy) {
    this.memberGroupStrategy = memberGroupStrategy.name();
    return this;
  }

  public GenericMulticastPartitionGroupConfig setTimestampProvider(AtomicCounter timestampProvider) {
    this.timestampProvider = timestampProvider;
    return this;
  }

  public AtomicCounter getTimestampProvider() {
